  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-gray-600 font-bold rounded-md w-full text-body",
        ...
        day_selected:
          "bg-accent-purple text-primary-foreground hover:bg-accent-purple hover:text-primary-foreground focus:bg-accent-purple focus:text-primary-foreground",
